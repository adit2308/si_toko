...
class M_inventory extends CI_Model {
    ...
    var $column_order = array(null, 'nama','kategori','sub_1','harga_beli','harga_jual','stok'); //set column field database for datatable orderable
    var $column_search = array('nama','kategori','sub_1','harga_beli','harga_jual','stok'); //set column field database for datatable searchable 
