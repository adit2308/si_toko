<div class="modal-header">
				<a href="<?php echo base_url();?>laporan/lap_pembelian" class="close">&times;</a>
		Filter Bulanan
		</div>
		<form class="form-horizontal" method="post" role="form" action="<?php echo base_url();?>laporan/filter_beli_bulanan">
