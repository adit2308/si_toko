<?php
if ($this->session->userdata('level') == 'owner' or 'admin' || $this->session->userdata('level') == 'developer') {
?>
	<!--DATA INVENTORY-->
	...
	<table id="dynatable" class="table table-striped table-bordered table-hover">
		...
		<tbody>
			<tr>
				<td></td>
				<td>
					<div id="col_nama" class="form-control" contenteditable="true" style="height: 55px;"></div>
				</td>
				<td>
					<div id="col_kat" style="height: 55px;">
				...
				<td>
					<div id="col_harga_b" class="form-control" contenteditable="true" style="height: 55px;"></div>
				</td>
				<td>
					<div id="col_harga_j" class="form-control" contenteditable="true" style="height: 55px;"></div>
				</td>
				<td>
					<div id="col_stok" class="form-control" contenteditable="true" style="height: 55px;"></div>
				</td>
